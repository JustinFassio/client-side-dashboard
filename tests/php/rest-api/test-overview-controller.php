/**
 * Tests for the Overview Controller REST API endpoints.
 *
...
/**
 * Test cases for the Overview Controller class.
 *
 * @package AthleteDashboard
 * @subpackage Tests
 */
class Overview_Controller_Test extends TestCase {
	...
	/**
	 * Test that overview data can be retrieved successfully.
	 */
	...
	/**
	 * Test that overview data is properly formatted.
	 */
	public function test_overview_data_format() {
		// Set current user
		\WP_Mock::userFunction( 'get_current_user_id' )->andReturn( $this->user_id );
	...
	/**
	 * Test that overview data is cached properly.
	 */
	public function test_overview_data_caching() {
		// Set current user
		\WP_Mock::userFunction( 'get_current_user_id' )->andReturn( $this->user_id );
	...
	/**
	 * Test that overview data respects user permissions.
	 */
	public function test_overview_data_permissions() {
